  ...
  try {
    ...
    if (status === "APPROVED" && lesson) {
      const { data: existing } = await supabaseAdmin
        ...
        .eq("lessonId", submission.lessonId)
        .single();
      ...
      if (module) {
        await checkAndIssueCertificate(submission.userId, module.courseId);
      }
    }
